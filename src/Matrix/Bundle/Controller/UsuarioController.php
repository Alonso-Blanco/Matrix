...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MatrixBundle:Usuario')->findAll();
     ...
     * @Method("POST")
     * @Template("MatrixBundle:Usuario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MatrixBundle:Usuario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MatrixBundle:Usuario:edit.html.twig")
     */
    ...
    public function loginAction(Request $request)
     {  
        ...
        if ($request->getMethod()=='POST') {
            ...
            $usuario = $repository-> findOneBy(array('cedula'=> $cedula, 'contrasena' =>$contrasena));
            if (!$usuario) {
                $usuario = $repository-> findOneBy(array('carne'=> $cedula, 'contrasena' =>$contrasena));
            }
            if ($usuario) {
              $login = new Usuario();
