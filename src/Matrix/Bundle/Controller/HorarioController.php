...
use Matrix\Bundle\Entity\Horario;
use Matrix\Bundle\Form\HorarioType;
...
class HorarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MatrixBundle:Horario')->findAll();
     ...
     * @Method("POST")
     * @Template("MatrixBundle:Horario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MatrixBundle:Horario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MatrixBundle:Horario:edit.html.twig")
     */
