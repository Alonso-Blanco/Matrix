...
use Matrix\Bundle\Entity\Grupo;
use Matrix\Bundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MatrixBundle:Grupo')->findAll();
     ...
     * @Method("POST")
     * @Template("MatrixBundle:Grupo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MatrixBundle:Grupo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MatrixBundle:Grupo:edit.html.twig")
     */
