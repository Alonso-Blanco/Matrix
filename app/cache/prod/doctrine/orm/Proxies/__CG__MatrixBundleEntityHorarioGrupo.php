 ...
 */
class HorarioGrupo extends \Matrix\Bundle\Entity\HorarioGrupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Matrix\\Bundle\\Entity\\HorarioGrupo' . "\0" . 'id', '' . "\0" . 'Matrix\\Bundle\\Entity\\HorarioGrupo' . "\0" . 'grupo', '' . "\0" . 'Matrix\\Bundle\\Entity\\HorarioGrupo' . "\0" . 'horario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HorarioGrupo $proxy) {
