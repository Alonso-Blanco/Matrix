 ...
 */
class EstudianteGrupo extends \Matrix\Bundle\Entity\EstudianteGrupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Matrix\\Bundle\\Entity\\EstudianteGrupo' . "\0" . 'id', '' . "\0" . 'Matrix\\Bundle\\Entity\\EstudianteGrupo' . "\0" . 'nota', '' . "\0" . 'Matrix\\Bundle\\Entity\\EstudianteGrupo' . "\0" . 'grupo', '' . "\0" . 'Matrix\\Bundle\\Entity\\EstudianteGrupo' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstudianteGrupo $proxy) {
