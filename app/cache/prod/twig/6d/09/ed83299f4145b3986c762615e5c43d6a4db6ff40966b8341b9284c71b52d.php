...
class __TwigTemplate_6d09ed83299f4145b3986c762615e5c43d6a4db6ff40966b8341b9284c71b52d extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["curso"]) ? $context["curso"] : null), "nombreCurso", array()), "html", null, true);
        echo "</h1>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["e"]) {
            // line 10
            echo "        ";
            if (((isset($context["grupo"]) ? $context["grupo"] : null) != $this->getAttribute($context["e"], "numerogrupo", array()))) {
                // line 11
                echo "        </ul>
        <hr class=\"separador\">
            <div class=\"fila\">
