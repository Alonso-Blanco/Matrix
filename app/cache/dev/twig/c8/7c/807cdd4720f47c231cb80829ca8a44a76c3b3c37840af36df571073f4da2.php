...
class __TwigTemplate_c87c807cdd4720f47c231cb80829ca8a44a76c3b3c37840af36df571073f4da2 extends Twig_Template
{
    ...
    <table class=\"table-list table record_properties\">
        ...
        <tbody>               
            <td>";
        // line 12
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "codigocarrera", array()), "html", null, true);
        echo "</td>            
            <td>";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "nombrecarrera", array()), "html", null, true);
        echo "</td>            
        </tbody>
    </table>
    ...
    <li class=\"list-tb\">
        <a href=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("carrera_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
