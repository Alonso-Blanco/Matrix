...
class __TwigTemplate_c678532dd078c7fcff4dc91133849ff4c91ad7d529e46aa9d80965ceda717090 extends Twig_Template
{
    ...
    <li class=\"list-tb\">
        <a href=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("estudiantegrupo_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
